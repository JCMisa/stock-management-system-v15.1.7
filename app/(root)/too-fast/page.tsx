    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="loader-logo">
        <div className="wrapper-logo">
          <div className="catContainer-logo">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 733 673"
              className="catbody-logo"
            >
              <path
                fill="#24ae7c"
              ...
              ></path>
              <path fill="#24ae7c" d="M184 9L270.603 159H97.3975L184 9Z"></path>
              <path fill="#24ae7c" d="M541 0L627.603 150H454.397L541 0Z"></path>
            </svg>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <div className="text-logo">
              <span className="bigzzz-logo">Z</span>
              <span className="zzz-logo">Z</span>
            </div>
          </div>
          <div className="wallContaine-logor">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 500 126"
      ...
      <div className="flex flex-col items-center justify-center mt-5">
        <h1 className="text-5xl font-bold text-dark-100 dark:text-light-100">
          Whoa, Slow Down There, Speedy!
        </h1>
        <p className="mt-3 max-w-xl text-center text-dark-400 dark:text-light-400">
        ...
        <Link
          href={"/dashboard"}
          className="p-3 px-5 rounded-lg min-w-52 text-center bg-primary hover:bg-primary-100 transition-all mt-3"
        >
          Back to Dashboard
        </Link>
      </div>
